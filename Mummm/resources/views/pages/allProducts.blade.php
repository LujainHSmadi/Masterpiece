...
@section('content')
   ...
   <div class="inner-page-main-wrapper float_left ptb-100">
            ...
            <div class="col-lg-4 col-md-4 col-12">
               ...
               <div class="side-bar-strip">
                  ...
                  <div class="side-accordian">
                     <ul>
                        <li><a href="javascript:;">Beef <span><svg
      ...
      " />
                        ...
                        <li><a href="javascript:;">Lamb <span>
         ...
         C734.7,387.9,731.1,391.4,727,391.4z" />
                        ...
                        <li><a href="javascript:;">Pork <span>
         ...
         C708.4,491.3,703,496.9,696.4,497z" />
                        ...
                        <li><a href="javascript:;">Poultry <span>
         ...
         C649.4,404.5,652.8,401.2,657.1,401.2z" />
                        ...
                        <li><a href="javascript:;">Sausage <span>
         ...
         c-1.7-1.7-2.6-1.9-4.4-0.1c-5.5,5.7-11.4,11-16.7,16.9c-16.2,17.9-20.3,38.4-11.4,60.8C380.6,626.8,401.3,640.3,428.9,640.3z
          ...
          M348.7,640.2c5.2,8.2,11.1,14.3,19.3,19.2c0-6.3,0-11.7,0-17.2c0-1.4-0.4-2.1-1.9-2C360.6,640.2,355.1,640.2,348.7,640.2z" />
                        ...
                        <li><a href="javascript:;">Deli <span>
         ...
         C516.3,438.5,511.3,433.3,511.4,427.2z" />
                        ...
                        <li><a href="javascript:;">Fish  <span>
               ...
               <div class="side-bar-strip">
                  ...
                  <div class="side-main-box">
                     <div class="side-img-box">
                        <img src="images/post1.jpg" alt="img">
                     </div>
                  ...
                  <div class="side-main-box">
                     <div class="side-img-box">
                        <img src="images/post3.jpg" alt="img">
                     </div>
                     <div class="side-img-content">
               ...
               <div class="blog-slider-wrapper float_left">
                  <div class="blog-cat">
                     <div class="blog-post-slider">
                        <div class="owl-carousel owl-theme">
                           <div class="item">
                              <img src="images/blog-post1.jpg" alt="img">
                           </div>
                           <div class="item">
                              <img src="images/blog-post2.jpg" alt="img">
                           </div>
                           <div class="item">
                              <img src="images/blog-post3.jpg" alt="img">
                           </div>
                        </div>
                     </div>
                     <div class="slider-content">
                        <del>$400.00</del>
                        <h4><a href="product-single.html">NOW ONLY $94.00</a></h4>
                        <div class="post-tag">
                           <a href="#">2 X 3-BONE RACKS (170G / 6OZ) </a>
                        </div>
                        <ul class="star-review">
                           <li> <a href="javascript:;"><i class="fa fa-star" aria-hidden="true"></i></a> </li>
                           <li> <a href="javascript:;"><i class="fa fa-star" aria-hidden="true"></i></a> </li>
                        ...
                        <a class="custom-btn" href="product-single.html">Add to Cart</a>
                     </div>
                  </div>
                  <!--  -->
                  ...
                  <div class="product-single-wrapper">
                     ...
                     <div class="custom-tabs-prdt">
                        <div class="product-thumbnail">
                           <a href="javascript:;">
                              <img src="images/product/pc2.png" alt="img">
                           </a>
                        </div>
                        <div class="product-body">
                           <h5 class="product-title">
                     ...
                     <div class="custom-tabs-prdt">
                        <div class="product-thumbnail">
                           <a href="javascript:;">
                              <img src="images/product/pc3.png" alt="img">
                           </a>
                        </div>
                        <div class="product-body">
                           <h5 class="product-title">
                           ...
                           <span class="product-price">4,500$ <span>4,600$</span> </span>
                           <p class="product-text">Lorem Ipsum is simply dummy text of the printing and typesetting
                              industry.</p>
                           <a class="custom-btn" href="product-single.html">Add Cart</a>
                        </div>
                     ...
                     <div class="custom-tabs-prdt">
                        ...
                        <div class="product-body">
                           ...
                           <span class="product-price">1,500$ <span>4,600$</span> </span>
                           <p class="product-text">Lorem Ipsum is simply dummy text of the printing and typesetting
                              industry.</p>
                           <a class="custom-btn" href="product-single.html">Add Cart</a>
                        </div>
